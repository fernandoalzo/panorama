...
export async function create_basic_chart(fechas, precios, token, num_dias) {
...
export async function create_detailed_chart(fechas, precios, criptomoneda, num_dias, canvas_id) {
